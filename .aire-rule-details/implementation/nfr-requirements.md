...
## Prerequisites
- Functional Design must be complete (artifacts in `.spec/aire-docs/implementation/design/functional-design/`); if it was skipped, use the intake brief + requirements + stories as inputs instead
- Execution plan must indicate NFR Requirements stage should execute

## Overview
Determine non-functional requirements for the whole system and make tech stack choices.

## Steps to Execute

### Step 1: Analyze Functional Design
- Read functional design artifacts from `.spec/aire-docs/implementation/design/functional-design/` (if it exists; else use the intake brief + requirements + stories)
...
### Step 4: Store Plan
- Save as `.spec/aire-docs/implementation/plans/nfr-requirements-plan.md`
...
- Create `.spec/aire-docs/implementation/design/nfr-requirements/nfr-requirements.md`
- Create `.spec/aire-docs/implementation/design/nfr-requirements/tech-stack-decisions.md`
...
```markdown
# 📊 NFR Requirements Complete - [project-name]
```
...
```markdown
> **📋 <u>**REVIEW REQUIRED:**</u>**  
> Please examine the NFR requirements at: `.spec/aire-docs/implementation/design/nfr-requirements/`
...
- Mark NFR Requirements stage complete in aire-state.md
