...
## Prerequisites
- NFR Requirements must be complete (artifacts in `.spec/aire-docs/implementation/design/nfr-requirements/`)
- Execution plan must indicate NFR Design stage should execute

## Overview
Incorporate NFR requirements into the system design using patterns and logical components.

## Steps to Execute

### Step 1: Analyze NFR Requirements
- Read NFR requirements from `.spec/aire-docs/implementation/design/nfr-requirements/`
...
### Step 4: Store Plan
- Save as `.spec/aire-docs/implementation/plans/nfr-design-plan.md`
...
- Create `.spec/aire-docs/implementation/design/nfr-design/nfr-design-patterns.md`
- Create `.spec/aire-docs/implementation/design/nfr-design/logical-components.md`
...
```markdown
# 🎨 NFR Design Complete - [project-name]
```
...
```markdown
> **📋 <u>**REVIEW REQUIRED:**</u>**  
> Please examine the NFR design at: `.spec/aire-docs/implementation/design/nfr-design/`
...
- Mark NFR Design stage complete in aire-state.md
